// ==UserScript==
// @name        Mousehunt AutoBot Revised Edition
// @author      Ooi Keng Siang, CnN, Binxxxx , OldXu
// @version    	1.1.20211214
// @namespace   http://ooiks.com/blog/mousehunt-autobot, https://devcnn.wordpress.com/ , https://gitee.com/MirrorCubeSquare
// @description Ooiks: An advance user script to automate sounding the hunter horn in MouseHunt application in Facebook with MouseHunt version 3.0 (Longtail) supported and many other features. CnN: An enhanced version to sound horn based on selected algorithm of event or location.OldXu: provides continuous support for new areas
// @require		https://cdn.jsdelivr.net/npm/jquery@2.2.2/dist/jquery.min.js
...
// @downloadURL https://gitee.com/MirrorCubeSquare/mousehunt-autobot/raw/master/autobot-script.js
// @grant		unsafeWindow
// @grant		GM_info
// ==/UserScript==
...
// // Default: 5 - 180
var hornTimeDelayMin = 35;
var hornTimeDelayMax = 75;
...
var showLastPageLoadTime = false;

// // Default time to reload the page when bot encounter error. (in seconds)
var errorReloadTime = 60;

// // Display the Webpage Refresh timer in header (true/false)
var isDisplayRefresh = false;
...
var objBestTrap = {
    weapon : {
        arcane : ['Circlet of Pursuing','New Horizon','Circlet of Seeking','Golem Guardian Arcane','Event Horizon','Infinite Winter Horizon','Droid Archmagus','Chrome Grand Arcanum','Chrome Arcane Capturing Rod','Grand Arcanum','Anniversary Arcane Capturing Rod Of Never Yielding Mystery','Arcane Capturing Rod Of Nev','Sprinkly Cupcake Surprise','Arcane Blast'],
        draconic : ['Dragon Slayer Cannon','Chrome Storm Wrought Ballista','Storm Wrought Ballista','Dragonvine Ballista','Blazing Ember Spear','Ice Maiden','Harrowing Holiday Harpoon Harp','Dragon Lance'],
        forgotten : ['Thought Obliterator','Thought Manipulator','Infinite Labyrinth','Golem Guardian Forgotten','Endless Labyrinth','Father Winter','Crystal Mineral Crusher','Crystal Crucible','Festive Forgotten Fir','Stale Cupcake Golem','Scarlet Ember Root','Tarannosaurus Rex','The Forgotten Art of Dance','Anniversary Ancient Box','Ancient Box'],
        hydro : ['Chrome School of Sharks','School of Sharks','Queso Fount','Golem Guardian Hydro','Rune Shark','Chrome Phantasmic Oasis','Phantasmic Oasis','Bubbles: The Party Crasher','Chrome Oasis Water Node','Oasis Water Node','Haunted Shipwreck','Glacier Gatler','Steam Laser Mk. III','Steam Laser Mk. II'],
        law : ['S.T.I.N.G.E.R.','Ember Prison Core','S.T.I.N.G.','Meteor Prison Core','Judge Droid','Surprise Party','Christmas Cactus','Law Laser','Engine Doubler','Bandit Deflector','Supply Grabber','S.L.A.C. II','The Law Draw','S.L.A.C'],
        physical : ['Smoldering Stone Sentinel','Chrome MonstroBot','Golem Guardian Physical','Sandstorm MonstroBot','Sandtail Sentinel','Rocket Propelled Gavel','Chrome RhinoBot','New Year\'s Fireworks','Warden Slayer','Enraged RhinoBot','Isle Idol','Chrome Onyx Mallet','RhinoBot'],
        rift : ['Chrome Celestial Dissonance','Celestial Dissonance','Timesplit Dissonance','Mysteriously unYielding','Focused Crystal Laser','Biomolecular Re-atomizer','Christmas Crystalabra','Wacky Inflatable Party People','Rift Glacier Gatler','Multi-Crystal Laser','Crystal Tower'],
        shadow : ['Chrome Temporal Turbine','Temporal Turbine','Goldfrost Crossbow','Interdimensional Crossbow','Clockwork Portal','Anniversary Reaper\'s Perch','Reaper\'s Perch','Sandcastle Shard','Dreaded Totem','Maniacal Brain Extractor','Terrifying Spider'],
        tactical : ['Slumbering Boulder','Sleeping Stone','Gouging Geyserite','Chrome Sphynx Wrath','Golem Guardian Tactical','Sphynx Wrath','Dimensional Chest','Chesla\'s Revenge','Zugzwang\'s Ultimate Move','Well of Wisdom','Isle Idol','Zugzwang\'s First Move','Veiled Vine','Horrific Venus Mouse','Thorned Venus Mouse','Blackstone Pass'],
    },

    base : {
        luck : ['Prestige Base','Adorned Empyrean Refractor Base','Minotaur Base','Glowing Golem Guardian Base','Fissure Base','Rift Base','Attuned Enerchi Induction Base','Monkey Jade Base','Sheep Jade Base','Depth Charge Base','Horse Jade Base','Snake Jade Base','Dragon Jade Base','Eerier Base','Papyrus Base'],
        power : ['Prestige Base','Adorned Empyrean Refractor Base','Minotaur Base','Tidal Base','Golden Tournament Base','Spellbook Base']
        //power : ['Minotaur Base','Glowing Golem Guardian Base','Tidal Base','Golden Tournament Base','Spellbook Base']
    }
};
...
var objDefaultFW = {
    ...
    base : 'Desert Heater Base',
    focusType : 'NORMAL',
    priorities : 'HIGHEST',
    cheese : new Array(g_fwStreakLength).fill('Gouda Cheese'),
...
var redSpongeCharm = ['Red Double', 'Red Sponge Charm'];
var yellowSpongeCharm = ['Yellow Double', 'Yellow Sponge Charm'];
var spongeCharm = ['Blue Double Sponge Charm', 'Sponge Charm'];
...
// // Labyrinth
var bestLabyBaseDefault = ['Minotaur Base', 'Labyrinth Base'];
var bestLabyBase = ['Minotaur Base', 'Labyrinth Base'];
var bestLabyBaseTreasure=['Treasure Seeker Base','Minotaur Base', 'Labyrinth Base'];
var bestLabyBaseTreasure2=['Minotaur Base', 'Treasure Seeker Base','Labyrinth Base'];
var objCodename = {
    FEALTY : "y",
    TECH : "h",
    SCHOLAR : "s",
...
var g_objConstTrap = {
    bait : {
        ...
        ANY_FESTIVE_GOUDA : {
            sort : 'best',
            name : ['Arctic Asiago', 'Nutmeg', 'Snowball Bocconcini', 'Festive Feta', 'Gingerbread', 'Gouda Cheese']
        },
        ANY_FESTIVE_SB : {
            sort : 'best',
...
var checkRefreshElement;
var kingTimeElement;
var lastKingRewardSumTimeElement;
var optionElement;
var travelElement;
var strHornButton = 'hornbutton';
var strCampButton = 'mousehuntHud-menu-item root';
var strInboxButton = 'Inbox';
var isNewUI = false;
var debugKR = false;
...
// 2019-02 For Fish Wrangle, look at event listener "message"

function ExecuteLunarReward() {
    //div.lunarNewYearCampBanner-claimHeightRewardButton"
    //<a href="#" class="mousehuntActionButton small" onclick="hg.views.HeadsUpDisplayLunarNewYearView.claimReward(this); return false;"><span>Claim Lunar Lantern bonus reward!</span></a></div>
    //<input class="mousehuntPage-puzzle-form-code-button" value="Claim" onclick="app.views.HeadsUpDisplayView.hud.submitPuzzleForm();return false;" type="submit">
    var lunarReward = document.getElementsByTagName("a");
    var lunarActive = document.getElementsByClassName("lunarNewYearCampBanner-claimHeightRewardButton");
    //alert (lunarActive[0]);
    //if  (lunarActive[0] !=="[object HTMLDivElement]") && (lunarActive[0] !=="undefined"){
    for (var i = 0; i < lunarReward.length; i++){
        if (lunarReward[i].innerText == "Claim Lunar Lantern bonus reward!"){
            //fireEvent(lunarReward, 'click');
            //alert ("lunartest");
            //alert (lunarReward[i].innerText);
        }
    }
    //}
}
...
function exeScript() {
    ...
    isAutoRefresh = getStorageToVariableBool("AutoRefresh", isAutoRefresh);
    ar_Interval = getStorageToVariableInt("AutoRefreshAR_Interval", ar_Interval);
    ...
    if (fbPlatform) {
        ...
        if (window.location.href == "http://www.mousehuntgame.com/canvas/" ||
            ...
            window.location.href.indexOf("mousehuntgame.com/canvas/camp.php") != -1 ||
            window.location.href.indexOf("mousehuntgame.com/canvas/?") != -1) {
            //window.location.href.indexOf("mousehuntgame.com/canvas/?") != -1 ||
            //isAutoRefresh && window.location.href.indexOf("mousehuntgame.com/canvas") != -1) {
            // In hunter's camp or have AutoRefresh on... execute the script!
            LoadBotHeader();
        }
        else {
        ...
        if (window.location.href == "http://mousehunt.hi5.hitgrab.com/#" ||
            ...
            window.location.href.indexOf("http://mousehunt.hi5.hitgrab.com/camp.php") != -1 ||
            isAutoRefresh && window.location.href.indexOf("http://mousehunt.hi5.hitgrab.com") != -1) {
            // In hunter's camp or have AutoRefresh on... execute the script!
            LoadBotHeader();
        }
        else {
...
function eventLocationCheck(caller) {
    ...
    switch (selAlgo){
        ...
        case 'Birthday 2020' :
            Birthday2020();break;
                    case 'Birthday 2020 V2' :
            Birthday2020V2();break;
        case 'Iceberg':
            iceberg(); break;
        case 'WWRift':
            wwrift(); break;
        ...
        case 'Fort Rox':
            fortRox(); break;
        case 'Test':
            checkThenArm('any', 'bait', ['Gouda Cheese', 'Brie Cheese']);
            break;
        default:
            break;
    }
...
function mapHunting(){
    ...
    var strViewState = getPageVariable('user.quests.QuestRelicHunter.value');
    //alert(strViewState);
    //	var bHasMap = (strViewState == 'hasMap' || strViewState == 'hasReward');
    var bHasMap = (strViewState !== 'null' || strViewState == 'hasReward');
    //alert(bHasMap);
...
//2018-08-29 MH update broke the map hunting feature. I believe this function was affected.
        ...
        if(arrUncaughtMouse.length != nRemaining){
            ...
            if(isNullOrUndefined(getMapPort)){
                ...
                ajaxPost(window.location.origin + '/managers/ajax/users/relichunter.php', objData, function (data){
                    ...
                    if(!isNullOrUndefined(data.treasure_map.goals)){
                        var arrUncaught = [];
                        for(var i=0;i<data.treasure_map.goals.length;i++){
                            if(data.treasure_map.goals[i].is_uncaught === true){
                                for(var j=0;j<data.treasure_map.goals[i].mice.length;j++){
                                    arrUncaught.push(data.treasure_map.goals[i].mice[j].name);
                                }
                            }
                        }
...
function bwRift(){
    ...
    var objDefaultBWRift = {
        ...
        master : {
            weapon : new Array(32).fill('Celestial Dissonance'),
        ...
        priorities : ['ACOLYTE', 'GUARD', 'INGRESS', 'FROZEN', 'LUCKY', 'HIDDEN', 'TIMEWARP', 'RUNIC', 'ANCIENT', 'GEARWORKS', 'GEARWORKS', 'GEARWORKS', 'GEARWORKS'],
        prioritiesCursed : ['SECURITY', 'FURNACE', 'PURSUER', 'ACOLYTE', 'GUARD', 'INGRESS', 'FROZEN', 'LUCKY', 'HIDDEN', 'TIMEWARP', 'RUNIC', 'ANCIENT', 'GEARWORKS'],
        minTimeSand : [90,90,70,70,70,70,60,40,999],
        minRSCType : 'NUMBER',
        minRSC : 0,
            ...
            if(objBWRift.choosePortal){
                if(nIndex === 0 || (nIndex > 0 && objUser.chamber_status == 'open' && objBWRift.choosePortalAfterCC)){
                    ...
                    if(arrAL.length > 0 && arrRL.length > 0 && nIndexCustom > -1){
                        ...
                        var nTotalASC2= nTotalASC-2*nRSCPot;
                        ...
                        if(nTotalASC2 < nTotalRSC){ // ancient first
...
function fortRox(){
    ...
    var objDefaultFRox = {
        ...
        bait : new Array(7).fill('Gouda Cheese'),
...
{
    var buttomToClaim=document.getElementsByClassName("superBrieFactoryHUD-claimButton")[0];
    hg.views.HeadsUpDisplaySuperBrieFactoryView.claimReward(buttomToClaim);
    var buttomToClose=document.getElementsByClassName("jsDialogClose button")[0];
     fireEvent(buttomToClose, 'click');
}
function Birthday2020(){
    var quest_main=user.quests.QuestSuperBrieFactory;
	if(GetCurrentLocation().indexOf('SUPER') < 0)
		return;
  // var test=getPageVariable('user.quests.QuestBirthday2020.factory_atts.can_claim');
    var test=quest_main.factory_atts.can_claim;
   // var test2=getPageVariable('user.quests.QuestBirthday2019.factory_atts.boss_warning');
    var locationIndex=['mixing_room','break_room','pumping_room','quality_assurance_room'];
    if( test==true)
        window.setTimeout(function () {claimBirthday(); }, 150);
}
function sortNumber(a,b)
{
    return a-b;
}
function equipBirthdaySetup(threshold)
{
    var quest_main=user.quests.QuestSuperBrieFactory;
	var eventCheeseAmount=quest_main.items.coggy_colby_cheese.quantity+quest_main.items.speed_coggy_colby_cheese.quantity;
	var frcAmount=quest_main.items.birthday_factory_trinket.quantity;
	var bossAvailable=quest_main.factory_atts.boss_warning!=null;
    checkThenArm(null, 'weapon', ['S.T.I.N.G.E.R.'], true)
	if(bossAvailable)
	{
		if(quest_main.items.birthday_factory_trinket.status=='active')
			{
				disarmTrap('trinket');
			}
        checkThenArm(null, 'bait', ['Gouda Cheese','SUPER|brie+']);
	}
	else
	{
		if(eventCheeseAmount<threshold)
		{
			checkThenArm('best', 'bait', ['SUPER|brie+','Gouda Cheese']);
			checkThenArm(null, 'trinket', 'Factory Repair Charm');
		}
		else if(eventCheeseAmount>(5*threshold+Math.floor(Math.random()*3)))
		{
			//items.birthday_factory_trinket.status
            if(quest_main.items.speed_coggy_colby_cheese.quantity>1)
            {
			checkThenArm('best', 'bait',[ 'Speedy Coggy Colby', 'Coggy Colby Cheese']);
            }
            else
            {
                checkThenArm('best', 'bait',[ 'Coggy Colby Cheese','Speedy Coggy Colby']);
            }
			if(quest_main.items.birthday_factory_trinket.status=='active')
			{
				disarmTrap('trinket');
                window.setTimeout(function () { checkThenArm(null, 'trinket', 'Snowball Charm'); }, 5000);

			}
		}
		else
		{
            if(getPageVariable('user.bait_name').indexOf('Gouda Cheese')>=0)
            {
                checkThenArm('best', 'bait', ['SUPER|brie+','Gouda Cheese']);
            }
		   if(quest_main.items.coggy_colby_cheese.status=='active'||quest_main.items.speed_coggy_colby_cheese.status=='active')
		   {
		   if(quest_main.items.birthday_factory_trinket.status=='active')
		   disarmTrap('trinket');
		   }
...
function Birthday2020V2(){
    var quest_main=user.quests.QuestSuperBrieFactory;
    if(GetCurrentLocation().indexOf('SUPER') < 0)
		return;
	equipBirthdaySetup(5);
   ...
   // var test2=getPageVariable('user.quests.QuestBirthday2019.factory_atts.boss_warning');
    ...
    if( test==true)
        window.setTimeout(function () { claimBirthday(); }, 150);
    var factory_room_stats=new Array(4);
factory_room_stats[0] = quest_main.items.birthday_factory_mixing_room_stat_item.quantity;
factory_room_stats[1] = quest_main.items.birthday_factory_break_room_stat_item.quantity;
factory_room_stats[2] = quest_main.items.birthday_factory_pumping_room_stat_item.quantity;
factory_room_stats[3] =quest_main.items.birthday_factory_quality_assurance_room_stat_item.quantity;
 var factory_room_stats_2=new Array(4);
factory_room_stats_2[0] = quest_main.items.birthday_factory_mixing_room_stat_item.quantity;
factory_room_stats_2[1] = quest_main.items.birthday_factory_break_room_stat_item.quantity;
factory_room_stats_2[2] = quest_main.items.birthday_factory_pumping_room_stat_item.quantity;
factory_room_stats_2[3] = quest_main.items.birthday_factory_quality_assurance_room_stat_item.quantity;
var debugger1=factory_room_stats.sort(sortNumber)[0];
    var lowestIndex=factory_room_stats_2.findIndex(function(e){return e==debugger1;})
var buttonToFire=document.getElementsByClassName('superBrieFactoryHUD-factoryRoom')[lowestIndex].getElementsByClassName('mousehuntActionButton tiny')[0];
var currentLocation=quest_main.factory_atts.current_room;
    var debugger2=(Math.abs(factory_room_stats[3]-factory_room_stats[0])<=(Math.floor(Math.random()*3)));
    if (debugger2) return;
    if(currentLocation!=locationIndex[lowestIndex])
window.setTimeout(function () { fireEvent(buttonToFire, 'click'); }, 150);
}
...
function iceberg(){
    ...
    var objDefaultIceberg = {
        ...
        bait : new Array(9).fill('Gouda Cheese')
    };
...
function zugzwangTower(){
    ...
    var objDefaultZT = {
        ...
        bait : new Array(14).fill('Gouda Cheese'),
    };
...
//Binxxxx: Start - Add function for Queso areas - 20180709
function QuesoCanyon() {
    var bestQCBase = ['Overgrown Ember Stone Base'];
    bestQCBase = arrayConcatUnique(bestQCBase, objBestTrap.base.luck);
    var bestQCcheese = ['Bland Queso'];
    var objDefaultQC = {
        levelQCspice : '',
        armQCBait : false
    };
    var objQC = getStorageToObject('QCArea', objDefaultQC);
    //NOTE: Guyser does not like Bland Queso, so it is added when in PP or CQ
    if (objQC.levelQCspice == 'Wildfire') {
        bestQCcheese = ['Wilfire Queso','Flamin\' Queso','Flamin\' Queso','Hot Queso','Medium Queso','Mild Queso'];
    }
    else if (objQC.levelQCspice == 'Flamin') {
        bestQCcheese = ['Flamin\' Queso','Hot Queso','Medium Queso','Mild Queso'];
    }
    else if (objQC.levelQCspice == 'Hot') {
        bestQCcheese = ['Hot Queso','Medium Queso','Mild Queso'];
    }
    else if (objQC.levelQCspice == 'Medium') {
        bestQCcheese = ['Medium Queso','Mild Queso'];
    }
    else if (objQC.levelQCspice == 'Mild') {
        bestQCcheese = ['Mild Queso'];
    }
    else if (objQC.levelQCspice == 'Bland') {
        bestQCcheese = ['Bland Queso'];
    }
    else {
        bestQCcheese = ['Flamin\' Queso','Hot Queso','Medium Queso','Mild Queso', 'Bland Queso'];
    }

    if (GetCurrentLocation().indexOf("Queso River") > -1) {
        if (objQC.armQCBait) {
            if (objQC.levelQCspice == 'Wildfire') {
                checkThenArm('best', 'bait', ['Wildfire Queso','Gouda Cheese','SB+']);
            }
            else {
                checkThenArm('best', 'bait', ['Gouda Cheese','SB+']);
            }
        }
        checkThenArm('best', 'weapon', objBestTrap.weapon.law);
    }
    if (GetCurrentLocation().indexOf("Prickly Plains") >-1) {
        if (objQC.armQCBait) {
            bestQCcheese = arrayConcatUnique(bestQCcheese, ['Bland Queso']);
            checkThenArm('best', 'bait', bestQCcheese);
        }
        checkThenArm('best', 'weapon', objBestTrap.weapon.arcane);
    }
    if (GetCurrentLocation().indexOf("Cantera Quarry") > -1) {
        if (objQC.armQCBait) {
            bestQCcheese = arrayConcatUnique(bestQCcheese, ['Bland Queso']);
            checkThenArm('best', 'bait', bestQCcheese);
        }
    ...
    if (GetCurrentLocation().indexOf("Queso Geyser")>-1) {
        if (objQC.armQCBait) {
            checkThenArm('best', 'bait', bestQCcheese);
        }
...
function autoUpgradeGolem()
{
	var objGWH2019=SON.parse(getPageVariable('JSON.stringify(user.quests.QuestWinterHunt2019)'));
	var level=[0,0,0];
	level[0]=objGWH2019.golems[0].level;
	level[1]=objGWH2019.golems[1].level;
	level[2]=objGWH2019.golems[2].level;
	upgradeGolem(level.indexOf(Math.max(...level)));
}
async function maxinumExplode()
{
	var objGWH2019=JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestWinterHunt2021)'));
    //if(!user.quests.QuestWinterHunt2021)return;
    for(i=0;i<10;i++)
    {
     //console.plog("testexplodecount");
	hg.views.HeadsUpDisplayWinterHunt2021View.bustCrust(document.createElement("a"));
        if(!user.quests.QuestWinterHunt2021.comet.can_break)break;

    }
    window.setTimeout( function(){document.querySelectorAll(".jsDialogClose").forEach(item=>{item.click();});}, 3000);
}
async function maxinumExplode_safe()
{
	var objGWH2019=JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestWinterHunt2021)'));
    if(isNullOrUndefined(user.quests.QuestWinterHunt2021.comet.can_explode))return;
    for(i=0;i<10;i++)
    {
     //console.plog("testexplodecount");
	await hg.views.HeadsUpDisplayWinterHunt2021View.bustCrust(document.createElement("a"));
        if(!user.quests.QuestWinterHunt2021)break;

    }
    await sleep(2000);
    document.querySelectorAll(".jsDialogClose").forEach(item=>{item.click();});
}
async function upgradeGolem(id)
{

	if(isNullOrUndefined(id)||id>2||id<0)return;
    if (user.quests.QuestWinterHunt2021.golems[id].can_upgrade!=true)return;
	var upgradeElement=document.createElement("a");
	upgradeElement.setAttribute("data-slot",id);
	upgradeElement.className="winterHunt2021HUD-popup-golem-upgradeButton ";
	await hg.views.HeadsUpDisplayWinterHunt2021View.upgradeGolem(upgradeElement);
    await sleep(2000);
    document.querySelectorAll(".jsDialogClose").forEach(item=>{item.click();});
...
async function claimReward(id)
{
	...
	if(isNullOrUndefined(id)||id>2||id<0)return;
    if (user.quests.QuestWinterHunt2021.golems[id].can_claim!=true)return;
	var upgradeElement=document.createElement("a");
	upgradeElement.setAttribute("data-slot",id);
	upgradeElement.className="winterHunt2021HUD-golemBuilder-golemButton";
	await hg.views.HeadsUpDisplayWinterHunt2021View.claimReward(upgradeElement);
    await sleep(2000);
    document.querySelectorAll(".jsDialogClose").forEach(item=>{item.click();});
}
async function sendGolem(id)
{
	var golemStatus=user.quests.QuestWinterHunt2021.golems[id];
	if (golemStatus.can_build==true)
	{
		var closeButtom=document.getElementsByClassName('jsDialogClose');
        if(closeButtom.length>0)closeButtom[0].click();
		var golemButtom=document.getElementsByClassName('winterHunt2021HUD-golemBuilder')[id];
		fireEvent(golemButtom, 'click');
        var dummy=document.createElement('a');
        dummy.className='winterHunt2021HUD-popup-sendGolemButton';
		await hg.views.HeadsUpDisplayWinterHunt2021View.buildGolem(dummy);
        await sleep(2000);
	}
}
async function sendGolemWithHat(id)
{
	var golemStatus=user.quests.QuestWinterHunt2021.golems[id];
	if (golemStatus.can_build==true)
	{
        ...
        var dummy=document.createElement('a');
        dummy.className='winterHunt2021HUD-popup-sendGolemButton';
		await hg.views.HeadsUpDisplayWinterHunt2021View.buildGolem(dummy,true);
        await sleep(2000);
	}
}
function map_callback_success(data)
{
    var mapId=data.treasure_map.map_id;
    console.log("map opened mapID:",mapId);
    console.log("map data:",data);
    hg.utils.TreasureMapUtil.leave(mapId,leave_callback,leave_callback);
    return;
}
function leave_callback(data)
{
    console.log("leave complete");
    return;
}
function onOpenNaughty()
{
    hg.utils.UserInventory.useConvertible('nice_list_convertible',1,map_callback_success);
    return;
}
async function GWH2020()
{
    //maxinumExplode();
    if(GetCurrentLocation().indexOf('Festive Comet')<0)return;
    await maxinumExplode_safe();
	var QuestWinterHunt2020=user.quests.QuestWinterHunt2021;
	var golemStatus=QuestWinterHunt2020.golems;
	var buildList=[];
	var upgradeList=[];
	var claimList=[];
	for (i=0;i<3;i++)
	{
		if (golemStatus[i].can_claim)
		{
			claimList.push(i);
		}
		if(golemStatus[i].can_build)
		{
			buildList.push(i);
		}
		if(golemStatus[i].can_upgrade)
		{
			upgradeList.push(i);
		}
	}
	...
	{
		//claimList
        await upgradeGolem(upgradeList[i]);
	}
    document.querySelectorAll(".jsDialogClose").forEach(item=>{
        item.click();
    });
	...
	{
		//claimList
        await upgradeGolem(claimList[i]);
		await claimReward(claimList[i]);
        await buildList.push(claimList[i]);
	}
    document.querySelectorAll(".jsDialogClose").forEach(item=>{
        item.click();
    });
	...
	{
        await sendGolem(buildList[i]);
    }
    }
   // if (user.quests.QuestWinterHunt2021.comet.can_explode==true)
    //{
       // maxinumExplode();
       // return;
   // }
   // sendGolem(0);
   // window.setTimeout( function(){sendGolem(1);}, 5000);
   // window.setTimeout( function(){sendGolem(2);}, 5000);
    await maxinumExplode_safe();
    document.querySelectorAll(".jsDialogClose").forEach(item=>{
        item.click();
    });
    //window.setTimeout( function(){maxinumExplode_safe();}, 15000);
}
...
function ValourRiftAugmentation (augmentationUsage)
{
    var augmentationUsageDefault={"Sigil Hunter":true,"Secret Research":false,"Super Siphon":false,"Ultimate Umbra":false,"Elixir Rain":false,"String Stepping":false};
    if(isNullOrUndefined(augmentationUsage))
    {
        augmentationUsage=augmentationUsageDefault;

    }
    var enterTowerButton=document.getElementsByClassName('valourRiftHUD-enterTowerButton')[0];
    fireEvent(enterTowerButton, 'click');
    var augmentationButtonCollection=document.getElementsByClassName('valourRiftHUD-augmentation');
    for(var aug of augmentationButtonCollection)
    {
        var name=aug.getElementsByClassName('valourRiftHUD-augmentation-name')[0].innerText;
        if(augmentationUsage[name])
        {
            fireEvent(aug, 'click');
        }
    }
...
function ToggleFire(objVRift)
{
    var objValourRift=JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestRiftValour)'));
    var is_fuel_enabled=objValourRift.is_fuel_enabled;
    return;
}
function ToggleCandle(mode)
{
	var UseRedCandle=false;
    var UseRedCandleOnly=false;
	var QuestLunarNewYear2020=JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestLunarNewYear2020)'));
    if(mode=="red")
    {
        UseRedCandle=true;
        mode="on";
    }
	if (!isNullOrUndefined(QuestLunarNewYear2020))
		{
			//In LNY2020
			var is_lantern_active=QuestLunarNewYear2020.is_lantern_active;
			var doubleCount=QuestLunarNewYear2020.items.lny_unlit_lantern_stat_item.quantity;
			var tripleCount=QuestLunarNewYear2020.items.lny_unlit_lantern_2018_stat_item.quantity;
			if(QuestLunarNewYear2020.is_lantern_active)
			{
				//Toggle Off If Specified in Mode
				if(mode=="off")
				{
					var ButtonToShut=document.getElementsByClassName("mousehuntItem-boundingBox active")[0];

					fireEvent(ButtonToShut, 'click');
				}
			}
			else
			{
				if(mode=="on")
				{
					if(tripleCount>0&&UseRedCandle)
					{
						var ButtonToOn=document.getElementsByClassName("lunarNewYearCampBanner-biscuit-lanternStatus {items.lny_unlit_lantern_2018_stat_item.status}}")[0];
						fireEvent(ButtonToOn, 'click');
					}
					else if(doubleCount>0&&(!UseRedCandleOnly))
					{
					var ButtonToOn=document.getElementsByClassName("lunarNewYearCampBanner-biscuit-lanternStatus {items.lny_unlit_lantern_stat_item.status}}")[0];
						fireEvent(ButtonToOn, 'click');
					}
				}
			}
...
function ValourRiftSimple()
{
    if(GetCurrentLocation().indexOf('Valour Rift')<0)
    return;
    checkThenArm('best','weapon',objBestTrap.weapon.rift);
    var objValourRift=JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestRiftValour)'));
    if(objValourRift.state.indexOf('tower')<0)
    {
        //enter tower
        var claimButton=document.getElementsByClassName('valourRiftHUD-claimButton')[0];
        fireEvent(claimButton, 'click');
        ValourRiftAugmentation(null);
        window.setTimeout(function () { fireEvent(document.getElementsByClassName('valourRiftPopupIllustrated-enterTowerButton')[0], 'click'); }, 150);
        return;
    }
    if(objValourRift.floor>8)
    {
        var retreatButton=document.getElementsByClassName('valourRiftHUD-retreatButton mousehuntTooltipParent')[0];
        fireEvent(retreatButton, 'click');
        var retreatConfirmButton=document.getElementsByClassName('valourRiftHUD-dialog-state retreat')[0].getElementsByClassName('mousehuntActionButton small')[1];
        window.setTimeout(function () { fireEvent(retreatConfirmButton, 'click'); }, 150);
        window.setTimeout(function () {ValourRiftSimple();},150);
    }
}
function ValourRift(){
    if(GetCurrentLocation().indexOf('Valour Rift')<0)
    ...
    checkThenArm('best','weapon',objBestTrap.weapon.rift);
    var objDefaultVRift = {
        VValourRiftNormalTrinket : 'Rift Vaccum',
        ValourRiftEclipseTrinket : 'Rift Vaccum',
        ValourRiftEclipseTrinketSafe : 'Rift Vaccum',
        ValourRiftFireUsage : 'eclipse',
        ValourRiftAutoEnter : true,
        ValourRiftAugmentationSigilHunter : false,
        ValourRiftAugmentationSecretResearch : false,
        ValourRiftAugmentationSuperSiphon : false,
        ValourRiftAugmentationUltimateUmbra : false,
        ValourRiftAugmentationElixirRain : false,
        ValourRiftAugmentationStringStepping : false
    };
    var objVRift = getStorageToObject('VRift', objDefaultVRift);
    var stepRemaining=-1;//calculate steps left to next floor
    var ForceFire=objVRift.ValourRiftFireUsage=='true';
    var NeverFire=objVRift.ValourRiftFireUsage=='never';
    var DoNotDisturb=objVRift.ValourRiftFireUsage=='asis';
    var ForceEclipseTest=false;
    var charmTowerNormal='Cherry Charm';
    var charmTowerEclipse=['Rift Ultimate Lucky Power Charm','Rift Ultimate Power Charm','Rift Ultimate Luck Charm'];
    var charmTowerEclipseSafe=['Rift Ultimate Lucky Power Charm','Rift Ultimate Power Charm','Rift Ultimate Luck Charm'];
    var objValourRift=JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestRiftValour)'));
    stepRemaining=(((100-objValourRift.floor_percent)*objValourRift.floor_steps/100)/(objValourRift.power_up_data.long_stride.current_value));//计算上提前开火的+1步
    var augmentationUsage={"Sigil Hunter":false,"Secret Research":false,"Super Siphon":false,"Ultimate Umbra":false,"Elixir Rain":false,"String Stepping":false};
    augmentationUsage["Sigil Hunter"]=objVRift.ValourRiftAugmentationSigilHunter;
    augmentationUsage["Secret Research"]=objVRift.ValourRiftAugmentationSecretResearch;
    augmentationUsage["Super Siphon"]=objVRift.ValourRiftAugmentationSuperSiphon;
    augmentationUsage["Ultimate Umbra"]=objVRift.ValourRiftAugmentationUltimateUmbra;
    augmentationUsage["Elixir Rain"]=objVRift.ValourRiftAugmentationElixirRain;
    augmentationUsage["String Stepping"]=objVRift.ValourRiftAugmentationStringStepping;
    var vscCount=document.getElementsByClassName('valourRiftHUD-gauntletBait-quantity quantity')[0].innerText.replace(',','')*1;
    var elixirCount=document.getElementsByClassName('valourRiftHUD-crafting-quantity quantity')[0].innerText.replace(',','')*1;
    var initialSync=objValourRift.initial_hunt_remaining;
    var nearEclipse=(stepRemaining<3 &&(objValourRift.floor%8==7))||objValourRift.is_at_eclipse||ForceEclipseTest||objValourRift.floor%8==0;
    if(vscCount+elixirCount*2>initialSync&&objValourRift.state.indexOf('tower')<0&&objVRift.ValourRiftAutoEnter)
    {
        //Enough vsc,enter tower
        var claimButton=document.getElementsByClassName('valourRiftHUD-claimButton')[0];
        fireEvent(claimButton, 'click');
        ValourRiftAugmentation(augmentationUsage);
        window.setTimeout(function () { fireEvent(document.getElementsByClassName('valourRiftPopupIllustrated-enterTowerButton')[0], 'click'); }, 150);
        return;
    }
    if(objValourRift.state.indexOf('farming')>-1)
    {
        checkThenArm(null, 'trinket', 'Rift Vacuum Charm');
        checkThenArm(null,'bait','Brie String Cheese');
        if(objValourRift.can_claim)
        {
            var claimButton=document.getElementsByClassName('valourRiftHUD-claimButton')[0];
            window.setTimeout(function () { fireEvent(claimButton, 'click'); }, 150);
        }
         var fireButton5=document.getElementsByClassName('valourRiftHUD-fuelContainer-armButton active')[0];
        window.setTimeout(function () { fireEvent(fireButton5, 'click'); }, 150);
            //window.setTimeout(function () {ToggleCandle("off");},5000);
            return;
    }
    else
    {
        ...
        if(!nearEclipse)
            checkThenArm(null, 'trinket', objVRift.ValourRiftNormalTrinket);
    }
        if((stepRemaining<=1 &&(objValourRift.floor%8==7))||objValourRift.is_at_eclipse||ForceEclipseTest||objValourRift.floor%8==0)
    {
        window.setTimeout(function () {ToggleCandle("red");},5000);
    }
    else
    {
        window.setTimeout(function () {ToggleCandle("on");},5000);
    }
    //if(DoNotDisturb)return;
    if((stepRemaining<=1 &&(objValourRift.floor%8==7))||objValourRift.is_at_eclipse||ForceEclipseTest||objValourRift.floor%8==0)
    {
        if(!objValourRift.is_at_eclipse||ForceEclipseTest)
        {
            checkThenArm('best','trinket',objVRift.ValourRiftEclipseTrinketSafe);
        }
        else
        {
            checkThenArm('best','trinket',objVRift.ValourRiftEclipseTrinket);
        }
        if(DoNotDisturb)return;
        if(NeverFire)
        {
            var fireButton4=document.getElementsByClassName('valourRiftHUD-fuelContainer-armButton active')[0];
        window.setTimeout(function () { fireEvent(fireButton4, 'click'); }, 150);
            //window.setTimeout(function () {ToggleCandle("off");},5000);
            return;
        }
        //right before or at eclipse
        var fireButton=document.getElementsByClassName('valourRiftHUD-fuelContainer-armButton')[0];
       // window.setTimeout(function () {ToggleCandle("on");},5000);
        if(!objValourRift.is_fuel_enabled)
        {
            window.setTimeout(function () { fireEvent(fireButton, 'click'); }, 150);
        }
    ...
    else if(ForceFire)
    {
        ...
        if(!objValourRift.is_fuel_enabled)
        {
            var fireButton2=document.getElementsByClassName('valourRiftHUD-fuelContainer-armButton')[0];
            window.setTimeout(function () { fireEvent(fireButton2, 'click'); }, 150);
        }
    }
    else
    {
        if(DoNotDisturb)return;
       // window.setTimeout(function () {ToggleCandle("off");},5000);
        var fireButton3=document.getElementsByClassName('valourRiftHUD-fuelContainer-armButton active')[0];
        window.setTimeout(function () { fireEvent(fireButton3, 'click'); }, 150);
    }

}
//Binxxxx: End - Add function for Queso areas - 20180709
function QuesoGeyser(){
    if(GetCurrentLocation().indexOf('Queso Geyser')<0)
        return;
    checkThenArm('best', 'weapon', objBestTrap.weapon.draconic);
    var CorkLevel=-1;//0=small,1=medium,2=large,3=epic
    var BarkRequired=[10,30,90,180];
    var SpecialResourceRequired=[0,15,30,60];
    var SpecialResourceAvailable=[false,false,false,false];
    var CorkAvailable=[false,false,false,false];
    //var objUser = JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestRiftBristleWoods)'));
    var objGeyser= JSON.parse(getPageVariable('JSON.stringify(user.quests.QuestQuesoGeyser)'));
    //geyserite_crafting_item
    //build_requirements
    //rubber_crafting_item
    //tungsten_crafting_item
    var ClassName=['quesoHUD-confirm-content-tabContent cork_basic','quesoHUD-confirm-content-tabContent cork_improved','quesoHUD-confirm-content-tabContent cork_heavy','quesoHUD-confirm-content-tabContent cork_sticky'];
    SpecialResourceAvailable[0]=objGeyser.corks.cork_basic.build_requirements.cork_bark_crafting_item.has_enough;
    SpecialResourceAvailable[1]=objGeyser.corks.cork_improved.build_requirements.rubber_crafting_item.has_enough;
    SpecialResourceAvailable[2]=objGeyser.corks.cork_heavy.build_requirements.geyserite_crafting_item.has_enough;
    SpecialResourceAvailable[3]=objGeyser.corks.cork_sticky.build_requirements.tungsten_crafting_item.has_enough;
    CorkAvailable[0]=objGeyser.corks.cork_basic.can_build
    CorkAvailable[1]=objGeyser.corks.cork_improved.can_build
    CorkAvailable[2]=objGeyser.corks.cork_heavy.can_build
    CorkAvailable[3]=objGeyser.corks.cork_sticky.can_build
    if(CorkAvailable[0]&& (!SpecialResourceAvailable[1])&& (!SpecialResourceAvailable[2])&& (!SpecialResourceAvailable[3]))CorkLevel=0;
    if(CorkAvailable[1]&& (!SpecialResourceAvailable[2])&& (!SpecialResourceAvailable[3]))CorkLevel=1;
    if(CorkAvailable[2]&& (!SpecialResourceAvailable[3]))CorkLevel=2;
    if(CorkAvailable[3])CorkLevel=3;
    var QuesoQuest=getPageVariable('user.quests.QuestQuesoGeyser');
    var CurrentState=getPageVariable('user.quests.QuestQuesoGeyser.state');
    //state: "corked"
    //state: "collecting"
    if (CurrentState.indexOf('collecting')>-1 &&CorkLevel>-1)
    {
        //Collecting
        if(CorkAvailable[CorkLevel])
        {
            //Current Level Can build
            var Test1=document.getElementsByClassName(ClassName[CorkLevel])[0];
            var Test2=Test1.getElementsByClassName('mousehuntActionButton small')[0];
            window.setTimeout(function () { fireEvent(Test2, 'click'); }, 150);
        }
    }
    if (CurrentState.indexOf('claim')>-1)
    {
        var claimGeyser=document.getElementsByClassName('quesoGeyserHUD-claimNestButton default')[0];
        window.setTimeout(function () { fireEvent(claimGeyser, 'click'); }, 150);
    }
    /*if(CurrentState.indexOf('claim')>0)
    {
        var claimButton=document.getElementsByClassName('quesoGeyserHUD-claimNestButton default')[0];
        //window.setTimeout(function () { fireEvent(claimButton, 'click'); }, 150);
     ｝*/
}
function SunkenCity(isAggro) {
    ...
    if (currentZone == objSCZone.ZONE_NOT_DIVE){
        ...
        checkThenArm('best', 'bait', ['Fishy Fromage', 'Gouda Cheese']);
        return;
    }
    ...
    if (currentZone == objSCZone.ZONE_OXYGEN || currentZone == objSCZone.ZONE_TREASURE || currentZone == objSCZone.ZONE_BONUS){
        if (isAggro && (currentZone == objSCZone.ZONE_TREASURE))
            checkThenArm('best', 'trinket', ['Golden Anchor', 'Empowered Anchor','Festive Anchor']);
        else{
        ...
        if (!isAggro){
            ...
            checkThenArm('best', 'trinket', ['Spiked Anchor', 'Empowered Anchor','Festive Anchor']);
        checkThenArm(null, 'bait', 'Gouda Cheese');
    }
...
function SCCustom() {
    ...
    var objDefaultSCCustom = {
        ...
        bait : new Array(11).fill('Gouda Cheese'),
...
function labyrinth() {
    //var test= getIdFromLocalStorage("Event Horizon");
    //armTrapDirect(null,"weapon","Event Horizon");
    if (GetCurrentLocation().indexOf("Labyrinth") < 0)
        return;

    var labyStatus = getPageVariable("user.quests.QuestLabyrinth.status");
    var lanternStatus = getPageVariable("user.quests.QuestLabyrinth.lantern_status");
...
var isAtFocus=(objLaby.districtFocus == strCurHallwayFullname.split(' ')[2]);
    var lanternUsage=objLaby.lanternUsage;
    console.plog('District to focus:', objLaby.districtFocus);//TREASURY
    if(objLaby.districtFocus=='TREASURY')
    {
        if(isAtHallway){
            var strCurHallwayFullname = document.getElementsByClassName('labyrinthHUD-hallwayName')[0].textContent.toUpperCase();
            if( strCurHallwayFullname.indexOf('TREASURY')<0)
        bestLabyBase=bestLabyBaseTreasure;
            else
                bestLabyBase=bestLabyBaseTreasure2;
        }
    }
	else bestLabyBase=bestLabyBaseDefault;

    bestLabyBase = bestLabyBase.concat(objBestTrap.base.luck).concat(objBestTrap.base.power);
    var charmArmed = getPageVariable('user.trinket_name');
    if(objLaby.armOtherBase != 'false'){
        if(charmArmed.indexOf('Compass Magnet') === 0||(objLaby.armOtherBase.indexOf('Prestige Base')>-1))
    ...
    if(objLaby.disarmCompass && charmArmed.indexOf('Compass Magnet') > -1){
        ...
        if(strCurHallwayFullname.indexOf('FARMING') > -1){
            if(strCurHallwayTier == 'PLAIN')
                checkThenArm('best', 'bait', 'Gouda Cheese');
            else if(strCurHallwayTier == 'SUPERIOR')
                checkThenArm('best', 'bait', ['Glowing Gruyere Cheese', 'Gouda Cheese']);
            checkThenArm('best', 'trinket', ['Super Nightshade Farming Charm', 'Nightshade Farming Charm']);
            ...
            checkThenArm('best', 'weapon', objBestTrap.weapon.forgotten);
            //Check to see if you are in a hallway that matches the focus of your run
            if (isAtFocus){
                //You are in a Fosued hallway, Arm GG if you got it
                checkThenArm('best', 'bait', ['Glowing Gruyere Cheese', 'Gouda Cheese', 'SB+']);
                if (objLaby.focusedCharm != 'None')
                    checkThenArm('best', 'trinket', objLaby.focusedCharm);
            }
            else {
                //You are NOT in Focus hall, arm Gouda
               // if(objLaby.districtFocus=='TREASURY'&&objTrapList.base.indexOf('Treasure Seeker Base')>-1)
                   // checkThenArm('best', 'bait', ['Glowing Gruyere Cheese', 'Gouda Cheese', 'SB+']);
                    //else
                                checkThenArm('best', 'bait', ['Glowing Gruyere Cheese', 'Gouda Cheese', 'SB+']);
                disarmTrap('trinket');
                    //checkThenArm('best', 'bait', ['Gouda Cheese', 'SB+', 'Glowing Gruyere Cheese']);
            }
        }
        ...
        var flag=false;
        if (lanternUsage=="Always")
        {
            flag=true;
        }
        else if(lanternUsage=="Focus")
        {
             if (objLaby.districtFocus == strCurHallwayFullname.split(' ')[2]){
                 flag=true;
             }
        }
        if(lanternStatus=="inactive"&&flag)
        {
            var lanternButton=document.getElementsByClassName('labyrinthHUD-toggleLantern mousehuntTooltipParent inactive')[0];
            fireEvent(lanternButton, 'click');
        }
                if(lanternStatus=="active"&&!flag)
        {
            var lanternButton=document.getElementsByClassName('labyrinthHUD-toggleLantern mousehuntTooltipParent active')[0];
            fireEvent(lanternButton, 'click');
        }
        return;
    }

    if( isAtExit || objLaby.districtFocus.indexOf('None') > -1){
        checkThenArm('best', 'weapon', objBestTrap.weapon.forgotten);
        //Check for preference to disarm bait when not in a hallway
        if (objLaby.interDisarmBait)
            disarmTrap('bait');
        checkThenArm(null, 'bait', 'Gouda Cheese');
        disarmTrap('trinket');
        return;
    ...
    for (var i=0;i<doorsIntersect.length;i++){
        ...
        if (doorsIntersect[i].getAttribute('class').indexOf('broken') > -1 || doorsIntersect[i].children.length<2){
            ...
            temp = doorsIntersect[i].children[1].innerText.toUpperCase().replace(/[\r\n]/g, "");
...
function zokor(){
    ...
    var objDefaultZokor = {
        ...
        bait : new Array(3).fill('Gouda Cheese'),
        trinket : new Array(3).fill('None')
    };
...
function fw(){
    ...
    if(isNullOrUndefined(objFW.cheese[objFW.streak]))
        objFW.cheese[objFW.streak] = 'Gouda Cheese';
...
function fRiftArmTrap(obj, nIndex, bReadJournal){
    ...
    else if (obj.bait[nIndex]=="Ascended=>Null Onyx Gorgonzola")
             {
                 checkThenArm('best', 'bait', ['Ascended','Null Onyx']);
             }
             else
...
function checkThenArm_dep(sort, category, name, isForcedRetry)
{
    var result=armTrapDirect(sort,category,name);
    return result;
}
function checkThenArm(sort, category, name, isForcedRetry) {  //category = weapon/base/charm/trinket/bait
    if(isNullOrUndefined(name) || name === '')
        return;
    if(Object.prototype.toString.call(name)==='[object Array]')name=name.filter(d=>d);
    if (category == "charm")
        category = "trinket";
    ...
    if(isNullOrUndefined(isForcedRetry))
        isForcedRetry = true;
    var result_direct=armTrapDirect(sort,category,name);
    if (result_direct=='ARMED')
        return;
...
function clickThenArmTrapInterval(sort, trap, name){
    //sort = power/luck/attraction
...
function armTrap(sort, trap, name) {
    return (isNewUI) ? armTrapDirect(sort,trap,name) : armTrapClassicUI(sort, trap, name);
}
...
function getIdFromLocalStorage(name)
{
    var rawData = localStorage.getItem("ownedTrap");
    if(name.indexOf("Golem Guardian")>=0)
       {
       name="Golem Guardian";
       }
       if(name.indexOf("Isle Idol")>=0)
    {
        name="Isle Idol";
    }
    if(rawData)
...
function armTrapDirect(sort,trap,name){
    var nametemp;
    var id;
    //Check if localStorage Exists
    var storageExists=(localStorage.getItem("ownedTrap")!= null)
    if(!storageExists)
    {
        //Try Fallback to traditional method
        armTrapNewUI(sort, trap, name);
        return LOADING;
    }
    else
    {
        if(typeof(name)=='object')
        {
            ...
            {
                nametemp=name[i];
                id =getIdFromLocalStorage(nametemp);
                if(id>0)
                {
                    //Found Best Trap
                    console.plog('Found best trap form armTrapDirect(): ' + nametemp+"id:"+id);
                    hg.utils.TrapControl.armItem(id, trap).go();
                    return ARMED;
                }
                else
                {
    ...
    {
        nametemp=name[i];
        var id =getIdFromLocalStorage(nametemp);
...
function getBaitQuantity() {
    ...
    var hudBaitQuantity= user.bait_quantity;
...
function retrieveData() {
    try {
        ...
        // get trap check time
        CalculateNextTrapCheckInMinute();
        //Check Area preference for auto-arm cheese
        getJournalDetail();
...
function action() {
    // Binxxxx: Reset page back to camp if the webpage has been idle.  Time is set in preferences.
    if (isAutoRefresh) {
        $(document.body).bind("click keydown", function(e) { checkRefresh = ar_Interval * 60; });
        function refresh() {
            if(checkRefresh <= 0) {
                var strTemp = "Recalculating Webpage Refresh...";
                var strHorn = timeFormat(hornTime);
                var strTrapCheck = timeFormat(checkTime);
                displayTimer(strTemp, strHorn, strTrapCheck, strTemp);
                //Return to camp by clicking on camp button
                fireEvent(document.getElementsByClassName(strCampButton)[0], 'click');
                reloadPage(false);
            }
            else setTimeout(refresh, 1000);
        }
        //Run the refresh function every second
    ...
    if (isKingReward) {
        ...
        // update timer
        var strTemp = "Out of pre-defined hunting location...";
        var strRefresh = timeFormat(checkRefresh);
        displayTimer(strTemp, strTemp, strTemp, strRefresh);
        if (fbPlatform)
        ...
        // update timer
        var strTitle = "No more cheese!";
        var strHorn = "Looking for area specific cheese...";
        var strTrapCheck = "Disabled while cheese searching...";
        var strRefresh = "Disabled while cheese searching...";
        displayTimer(strTitle, strHorn, strTrapCheck, strRefresh);
        displayLocation(huntLocation);
        displayKingRewardSumTime(null);
        if (isAutoRefresh) {
            //Return to camp by clicking on camp button
            fireEvent(document.getElementsByClassName(strCampButton)[0], 'click');
            // Check if area preferences will autoarm cheese when you run out
            setTimeout(eventLocationCheck('action()'), 10000);
        }
        //Need a waiting period then check the cheese quantity
        window.setTimeout(function () {
            g_nBaitQuantity = getBaitQuantity();
            if (g_nBaitQuantity === 0) { // Do nothing... pause the script
            }
            else YouGotCheese();
        }, 5000);
    }
...
function YouGotCheese() {
	...
	var headerElement = (isNewUI) ? document.getElementById('envHeaderImg'): document.getElementById('header');
    if (headerElement) {
...
function countdownTimer() {
    try {
        if (isKingReward) {
            // update timer
            var strTemp = "King's Reward!";
            var strRefresh = timeFormat(checkRefresh);
            displayTimer(strTemp, strTemp, strTemp, strTemp);
            ...
            if (lastKingRewardSumTime != -1) lastKingRewardSumTime += intervalTime;
            if (isAutoRefresh) checkRefresh -= intervalTime;
            intervalTime = undefined;

            //if (checkRefresh <=0) AutoRefresh();

            var strTitle = "No more cheese!";
            var strHorn = "Cannot hunt without the cheese...";
            var strTrapCheck = "Cannot solve KR without the cheese...";
            var strRefresh = timeFormat(checkRefresh);
            if (hornTime <= 0) {
                // blow the horn!
                hornTime = 0;
                if(getBaitQuantity() > 0)
                    ...
                    displayTimer(strTitle, strHorn, strTrapCheck, strTitle);
                    displayLocation(huntLocation);
                    displayKingRewardSumTime(null);
                }
            }
                ...
                if (enableTrapCheck && isAutoRefresh) {
                    // update Horn, Trap check, and Refresh timers (assumes refresh time = true in preferences)
                    if (!aggressiveMode) {
                        displayTimer("Horn: " + timeFormat(hornTime) + " | Check: " + timeFormat(checkTime) + " | Refresh: " + timeFormat(checkRefresh),
                                     ...
                                     timeFormat(checkRefresh));
                    }
                    else {
                        displayTimer("Horn: " + timeFormat(hornTime) + " | Check: " + timeFormat(checkTime) + " | Refresh: " + timeFormat(checkRefresh),
                                     timeFormat(hornTime) + "  <i>(same as MouseHunt timer)</i>",
                                     timeFormat(checkTime) + "  <i>(included extra " + timeFormat(checkTimeDelay) + " delay)</i>",
                                     timeFormat(checkRefresh));
                    }
                }
                else if (enableTrapCheck) {
                    // update Horn and Trap check
                    if (!aggressiveMode) {
                    ...
                    // update Horn timer only
                    if (!aggressiveMode) {
                        displayTimer("Horn: " + timeFormat(hornTime) + " | Refresh: " + timeFormat(checkRefresh),
                                     timeFormat(hornTime) + "  <i>(included extra " + timeFormat(hornTimeDelay) + " delay & +/- 5 seconds different from MouseHunt timer)</i>",
                                     timeFormat(checkRefresh));
...
function embedTimer(targetPage) {
    if (showTimerInPage) {
        var headerElement;
        var g_strVersion = GM_info.script.version;
        var g_strStriptName = GM_info.script.name;
        ...
        if (headerElement) {
            ...
            if (targetPage && aggressiveMode)
                titleElement.innerHTML = "<a href=\"https://gitee.com/MirrorCubeSquare/mousehunt-autobot\" target=\"_blank\"><b>" + g_strStriptName + " (version " + g_strVersion + ")</b></a> - <font color='red'>Aggressive Mode</font>";
            else if (targetPage && browser != 'chrome' && browser != 'opera' && browser != 'firefox')
                titleElement.innerHTML = "<a href=\"https://gitee.com/MirrorCubeSquare/mousehunt-autobot\" target=\"_blank\"><b>" + g_strStriptName + " (version " + g_strVersion + ")</b></a> - <font color='red'><b>Use Chrome, Opera or Firefox for full features</b></font>";
            else
                titleElement.innerHTML = "<a href=\"https://gitee.com/MirrorCubeSquare/mousehunt-autobot\" target=\"_blank\"><b>" + g_strStriptName + " (version " + g_strVersion + ")</b></a>";
            ...
            if (targetPage) {
                ...
                if (isAutoRefresh && isDisplayRefresh) {
                    checkRefreshElement = document.createElement('div');
                    checkRefreshElement.setAttribute('id', 'checkRefreshElement');
                    checkRefreshElement.innerHTML = "<b>Webpage Refresh:</b> Loading...";
                    timerDivElement.appendChild(checkRefreshElement);
                }
                ...
                //forceRefreshTimer= window.setTimeout(function () { window.location.reload(); }, timerRefreshInterval * 600000);
                // console.log('timer created'+forceRefreshTimer);
                var helpTextElement = document.createElement('div');
                //var timerStopTextElement=document.createElement('div');
                ...
                //var timerStopTextElment=document.createElement('div');
                //timerStopTextElement.innerHTML='<a id="stopTimer1" onclick="window.clearTimeout('+forceRefreshTimer+')">Stop Force Refresh</a>';
                timerDivElement.appendChild(helpTextElement);
                //timerDivElement.appendChild(timerStopTextElement);
                //timerStopTextElement=null;
                document.getElementsByClassName('mousehuntHud-menu-item root')[0].setAttribute("onclick","window.setTimeout(function () { window.location.reload(); }, 6000);");
...
">';
            ...
            var ticketsPreferenceStr = '<a id="idTickets" style="display:none" name="Tickets" title="Click to return tickets" onclick="onOpenNaughty();">';
            ticketsPreferenceStr += '<b>[Tickets]</b>';
            ticketsPreferenceStr += '</a>&nbsp;&nbsp;&nbsp;';
            var autoloaderStr='<a id="bookmarkletloader"  href="javascript:void%20!function()%7Bfunction%20t(t)%7Bvar%20e=document.createElement(%22script%22),s=%22https://cdn.jsdelivr.net/gh/tsitu/MH-Tools@%22+t+%22/src/bookmarklet/bm-menu.min.js%22;e.src=s,document.body.appendChild(e),e.onload=function()%7Be.remove()%7D%7Dnew%20Promise(function(t,e)%7Bvar%20s=new%20XMLHttpRequest;s.open(%22GET%22,%22https://api.github.com/repos/tsitu/MH-Tools/commits?sha=gh-pages%22),s.onreadystatechange=function()%7Bthis.readyState===XMLHttpRequest.DONE&amp;&amp;(200===this.status?t(s.responseText):e(this))%7D,s.onerror=function()%7Be(this)%7D,s.send()%7D).then(function(e)%7Bif(void%200!==JSON.parse(e)%5B0%5D)%7Bvar%20s=JSON.parse(e)%5B0%5D.sha;localStorage.setItem(%22tsitu-latest-sha%22,s),t(s)%7D%7D).catch(function(e)%7Bvar%20s=localStorage.getItem(%22tsitu-latest-sha%22);s&amp;&amp;s.length%3E0&amp;&amp;t(s)%7D)%7D();"><b>[Auto-Loader]</b></a>';
...
">';
            ...
            showPreferenceSpan.innerHTML = ticketsPreferenceStr + restorePreferenceStr + getLogPreferenceStr + clearTrapListStr + showPreferenceLinkStr+autoloaderStr;
            ...
            //Binxxxx!: Start code for AutoRefresh preferences
            preferenceHTMLStr += '<tr>';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
            preferenceHTMLStr += '<a title="Automatically refresh the page"><b>Automatic Refresh</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="AutoRefreshInput" onchange="var isDisable = (value == \'false\') ? \'disabled\' : \'\'; document.getElementById(\'AutoRefreshAR_Intervalinput\').disabled=isDisable;">';
            if (isAutoRefresh) {
                preferenceHTMLStr += '<option value="false">False</option>';
                preferenceHTMLStr += '<option value="true" selected>True</option>';
                temp = '';
            ...
            preferenceHTMLStr += '</select>&nbsp;&nbsp;<a title="Automatic Refresh Interval (in minutes)"><b>Interval:</b></a>&emsp;';
            preferenceHTMLStr += '<input type="number" id="AutoRefreshAR_Intervalinput" min="1" max="1440" size="5" value="' + ar_Interval.toString() + '" ' + temp + '> minutes';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            //Binxxxx!: End code for AutoRefresh preferences
...
window.localStorage.setItem(\'AutoRefresh\', 			document.getElementById(\'AutoRefreshInput\').value);\
window.localStorage.setItem(\'AutoRefreshAR_Interval\', 	document.getElementById(\'AutoRefreshAR_Intervalinput\').value);\
...
';
            ...
            preferenceHTMLStr += '<option value="Birthday 2020 V2">Birthday 2020 V2</option>';
            preferenceHTMLStr += '<option value="Iceberg">Iceberg</option>';
            preferenceHTMLStr += '<option value="Labyrinth">Labyrinth</option>';
            preferenceHTMLStr += '<option value="All LG Area">LG All Areas</option>';
            preferenceHTMLStr += '<option value="QuesoCanyon">Queso Canyon</option>';
            ...
            preferenceHTMLStr += '<option value="Valour Rift Simple">Valour Rift (9F Retreat)</option>';
			preferenceHTMLStr += '<option value="GWH2019">GWH2019</option>';
            ...
            preferenceHTMLStr += '<option value="Gouda Cheese">Gouda</option>';
            preferenceHTMLStr += '<option value="SUPER|brie+">SB+</option>';
            preferenceHTMLStr += '<option value="Toxic SUPER|brie+">Toxic SB+</option>';
             preferenceHTMLStr += '<option value="Empowered SUPER|brie+">Emp SB+</option>';
            ...
            preferenceHTMLStr += '<option value="Celestial Dissonance">CDT</option>';
            ...
            //Father Winter
            preferenceHTMLStr += '<option value="Father Winter">FWT</option>';
            ...
            preferenceHTMLStr += '<option value="Prestige Base">Prestige Base</option>';
            ...
            preferenceHTMLStr += '<option value="None">None</option>';
            preferenceHTMLStr += '<option value="Runic String Cheese">Runic</option>';
            preferenceHTMLStr += '<option value="Ancient String Cheese">Ancient</option>';
            preferenceHTMLStr += '<option value="Runic/Ancient">Runic/Ancient</option>';
            preferenceHTMLStr += '<option value="Runic=>Ancient">Runic=>Ancient</option>';
            preferenceHTMLStr += '<option value="Magical String Cheese">Magical</option>';
            preferenceHTMLStr += '<option value="Brie String Cheese">Brie</option>';
            preferenceHTMLStr += '<option value="Swiss String Cheese">Swiss</option>';
            preferenceHTMLStr += '<option value="Marble String Cheese">Marble</option>';
            preferenceHTMLStr += '</select>';
            ...
            preferenceHTMLStr += '<option value="Law Laser">Law Laser Trap</option>';
            preferenceHTMLStr += '<option value="Meteor Prison Core">Meteor Prison Core Trap</option>';
            preferenceHTMLStr += '<option value="Ember Prison Core">Ember Prison Core Trap</option>';
            preferenceHTMLStr += '</select>';
            ...
            preferenceHTMLStr += '<option value="Celestial Dissonance">CDT</option>';
            preferenceHTMLStr += '<option value="Timesplit Dissonance">TDW</option>';
            preferenceHTMLStr += '<option value="Mysteriously unYielding">MYNORCA</option>';
            preferenceHTMLStr += '<option value="Focused Crystal Laser">FCL</option>';
            preferenceHTMLStr += '<option value="Multi-Crystal Laser">MCL</option>';
            preferenceHTMLStr += '<option value="Biomolecular Re-atomizer">BRT</option>';
            preferenceHTMLStr += '<option value="Crystal Tower">CT</option>';
            preferenceHTMLStr += '</select>';
            ...
            preferenceHTMLStr += '<option value="Attuned Enerchi Induction Base">A. Enerchi</option>';
            preferenceHTMLStr += '<option value="Minotaur Base">Minotaur</option>';
            preferenceHTMLStr += '<option value="Furoma Base">Furoma Base</option>';
            preferenceHTMLStr += '</select>';
            ...
            preferenceHTMLStr += '<option value="Ascended=>Null Onyx Gorgonzola">Ascended+Null Onyx</option>';
            ...
            preferenceHTMLStr += '<option value="Maki String Cheese">Maki</option>';
            preferenceHTMLStr += '<option value="Magical String Cheese">Magical</option>';
            preferenceHTMLStr += '<option value="Brie String Cheese">Brie</option>';
            preferenceHTMLStr += '<option value="Swiss String Cheese">Swiss</option>';
            preferenceHTMLStr += '<option value="Marble String Cheese">Marble</option>';
            ...
            preferenceHTMLStr += '<tr id="trQuesoCanyonAutoCheese" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select to Auto Arm Queso Cheeses"><b>Auto Arm Queso</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectQCAutoBait" onchange="saveQC();">';
            preferenceHTMLStr += '<option value="false">False</option>';
            preferenceHTMLStr += '<option value="true">True</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            preferenceHTMLStr += '<tr id="trQuesoCanyonSpiceLevel" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select your starting spice level of Cheese to arm"><b>Spice Level</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectQCspiceLevel" onchange="saveQC();">';
            preferenceHTMLStr += '<option value="Best">Best</option>';
            preferenceHTMLStr += '<option value="Wildfire">Wildfire</option>';
            preferenceHTMLStr += '<option value="Flamin">Flamin</option>';
            preferenceHTMLStr += '<option value="Hot">Hot</option>';
            preferenceHTMLStr += '<option value="Medium">Medium</option>';
            preferenceHTMLStr += '<option value="Mild">Mild</option>';
            preferenceHTMLStr += '<option value="Bland">Bland - PP or CQ only</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';

            preferenceHTMLStr += '<tr id="trValourRiftNormalTrinket" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select Your Normal Charm in Tower"><b>Normal Charm</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectValourRiftNormalTrinket" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="None">None</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';

            preferenceHTMLStr += '<tr id="trValourRiftEclipseTrinket" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select Your Charm for Eclipse"><b>Eclipse Charm</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectValourRiftEclipseTrinket" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="None">None</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';

            preferenceHTMLStr += '<tr id="trValourRiftEclipseTrinketSafe" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select Your Charm for Eclipse(Safe)"><b>Eclipse Charm(Safe)</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectValourRiftEclipseTrinketSafe" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="None">None</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';

            preferenceHTMLStr += '<tr id="trValourRiftAutoEnter" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Auto Enter"><b>Auto Enter</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectValourRiftAutoEnter" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="true">True</option>';
            preferenceHTMLStr += '<option value="false">False</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            ...
            preferenceHTMLStr += '<tr id="trValourRiftFireUsage" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Champion Fire Usage"><b>Champion Fire Usage</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectValourRiftFireUsage" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="true">Always</option>';
            preferenceHTMLStr += '<option value="eclipse">Eclipse Only</option>';
            preferenceHTMLStr += '<option value="never">Never</option>';
            preferenceHTMLStr += '<option value="asis">As-Is</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            //    var augmentationUsage={"Sigil Hunter":true,"Secret Research":false,"Super Siphon":false,"Ultimate Umbra":false,"Elixir Rain":false,"String Stepping":false};
            preferenceHTMLStr += '<tr id="trValourRiftAugmentation" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select Augmentations to activate when auto-entering tower"><b>Tower Augmentations</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectValourRiftAugmentationSigilHunter" style="width: 75px;" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="false">Deactivate Sigil Hunter</option>';
            preferenceHTMLStr += '<option value="true">Activate Sigil Hunter</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '<select id="selectValourRiftAugmentationSecretResearch" style="width: 75px;" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="false">Deactivate Secret Research</option>';
            preferenceHTMLStr += '<option value="true">Activate Secret Research</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '<select id="selectValourRiftAugmentationSuperSiphon" style="width: 75px;" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="false">Deactivate Super Siphon</option>';
            preferenceHTMLStr += '<option value="true">Activate Super Siphon</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '<select id="selectValourRiftAugmentationUltimateUmbra" style="width: 75px;" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="false">Deactivate Ultimate Umbra</option>';
            preferenceHTMLStr += '<option value="true">Activate Ultimate Umbra</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '<select id="selectValourRiftAugmentationElixirRain" style="width: 75px;" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="false">Deactivate Elixir Rain</option>';
            preferenceHTMLStr += '<option value="true">Activate Elixir Rain</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '<select id="selectValourRiftAugmentationStringStepping" style="width: 75px;" onchange="saveVRift();">';
            preferenceHTMLStr += '<option value="false">Deactivate String Stepping</option>';
            preferenceHTMLStr += '<option value="true">Activate String Stepping</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            ...
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '&nbsp;&nbsp;&nbsp;&nbsp;';
            preferenceHTMLStr += '<a title="Select a charm"><b>Charm in Focus Hall</b></a>';
            preferenceHTMLStr += '&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '<select id="selectFocusedCharm" onChange="saveLaby();">';
            preferenceHTMLStr += '<option value="None">None</option>';
            preferenceHTMLStr += '<option value="Lantern Oil Charm">Lantern Oil</option>';
            preferenceHTMLStr += '<option value="Super Lantern Oil Charm">Super Lantern Oil</option>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            ...
            preferenceHTMLStr += '<input type="number" id="inputLabyrinthLastHunt" min="2" max="10" style="width:35px" value="2" onchange="onInputLabyrinthLastHuntChanged(this);">&nbsp;Hunt(s) in Hallway Near 100 Total Clues';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';

            preferenceHTMLStr += '<tr id="trLabyrinthArmOtherBase" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select to arm other base if Compass Magnet Charm is currently armed OR Is Prestige Base"><b>Arm Other Base</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            ...
            preferenceHTMLStr += '<input type="number" id="inputLabyrinthDEC" min="0" max="20" style="width:35px" value="0" onchange="onInputLabyrinthDECChanged(this);">';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
...
document.getElementById(\'interDisarmBait\').disabled = (value == \'true\') ? \'disabled\' : \'\'; ">';
            preferenceHTMLStr += '<option value="false">False</option>';
            preferenceHTMLStr += '<option value="true">True</option>';
            ...
            preferenceHTMLStr += '<tr id="trLabyrinthIntersection" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
            preferenceHTMLStr += '<a title="When not opening a focus door, don\'t waste cheese."><b>Disarm Bait at Intersection</b></a>';
            preferenceHTMLStr += '&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="interDisarmBait" onChange="saveLaby();">';
            preferenceHTMLStr += '<option value="false">False</option>';
            preferenceHTMLStr += '<option value="true">True</option>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            ...
            preferenceHTMLStr += '<tr id="trLabyrinthLanternUsage" style="display:none;">';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Lantern Usage"><b>Lantern Usage</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectLabyrinthLanternUsage" onchange="saveLaby();">';
            preferenceHTMLStr += '<option value="Always">Always</option>';
            preferenceHTMLStr += '<option value="Focus">Focus</option>';
            preferenceHTMLStr += '<option value="As-Is">As-Is</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
            ...
            preferenceHTMLStr += '<option value="Candy Corn">Candy Corn</option>';
            preferenceHTMLStr += '<option value="ANY_HALLOWEEN">Ghoulgonzola/Candy Corn</option>';
            preferenceHTMLStr += '<option value="Glowing Gruyere Cheese">GG</option>';
            preferenceHTMLStr += '</select>&nbsp;&nbsp;';
            ...
            document.getElementById('idTickets').style.display = (targetPage) ? 'table-row' : 'none';
...
function loadPreferenceSettingFromStorage() {
   ...
   aggressiveMode=false;
    ...
    //Binxxxx!: AutoRefresh - next 2 lines added
    //isAutoRefresh = getStorageToVariableBool("AutoRefresh", isAutoRefresh);
    //ar_Interval = getStorageToVariableInt("AutoRefreshAR_Interval", ar_Interval);
...
function displayTimer(title, nextHornTime, checkTime, checkRefresh) {
    if (showTimerInTitle) {
    ...
    if (showTimerInPage) {
        ...
        if (enableTrapCheck) checkTimeElement.innerHTML = "<b>Next Trap Check Time:</b> " + checkTime;
        if (isAutoRefresh && isDisplayRefresh) checkRefreshElement.innerHTML = "<b>Webpage Refresh:</b> " + checkRefresh;
    }
...
function soundHorn() {
    ...
    //if not at camp and AutoFresh is on, return to camp
    if (isAutoRefresh && !isAtCampPage) {
        //Return to camp by clicking on camp button
        fireEvent(document.getElementsByClassName(strCampButton)[0], 'click');
        isAtCampPage = 'true';
        LoadBotHeader();
    ...
    if (!isAtCampPage) {
        var strTemp = "Not At Camp Page";
        displayTimer(strTemp, strTemp, strTemp, timeFormat(checkRefresh));
        window.setTimeout(function () { soundHorn(); }, timerRefreshInterval * 5000);
        return;
    }

    // update timer
    var strTemp = "Ready to Blow The Horn...";
    displayTimer(strTemp, strTemp, strTemp, strTemp);
    ...
    if (!aggressiveMode) {
        ...
        if (headerElement) {
            ...
            if (headerStatus.indexOf("hornready") != -1) {
                ...
                // update timer
                var strTempTitle = "Synchronizing Data...";
                var strTemp = "Horn initiated, Synchronizing data...";
                displayTimer(strTempTitle, strTemp, strTemp, timeFormat(checkRefresh));
                ...
                // update timer
                var strTempTitle = "Calculating horn time...";
                var strTemp = "Waiting for Hunter horn...";
                displayTimer(strTempTitle, strTemp, strTemp, timeFormat(checkRefresh));
                ...
                // update timer
                var strTemp = "Hunter horn is missing. Synchronizing data...";
                displayTimer(strTemp, strTemp, strTemp, timeFormat(checkRefresh));
            ...
            // something wrong, can't even find the header...
...
function afterSoundingHorn(bLog) {
    ...
    if (headerElement) {
        ...
        if (headerStatus.indexOf("hornready") != -1) {
            ...
            // update timer
            var strTemp = "Blowing The Horn Again...";
            displayTimer(strTemp, strTemp, strTemp, timeFormat(checkRefresh));
            ...
            // the horn is already sound, but the network too slow on fetching the data

            // update timer
            var strTemp = "The horn sounding taken extra longer than normal...";
            displayTimer(strTemp, strTemp, strTemp, timeFormat(checkRefresh));
            ...
            // update timer
            var strTemp = "Horn sounded. Synchronizing Data...";
            displayTimer(strTemp, strTemp, strTemp, timeFormat(checkRefresh));

            // reload data
            retrieveData();
            //v1.39 Check for zero bait and check area specific cheese?
            ...
            // reset the horn retry counter
            hornRetry = 0;
            //Get eventLocationCheck()for second time
            window.setTimeout(function () { eventLocationCheck('afterSoundingHorn'); }, 5000);
        }
    }
}
    ...
    if (interval < 0)
    {
        if (isReloadToSolve)
        {
            ...
            if(isNewUI){
                ...
                var campElement = document.getElementsByClassName(strCampButton)[0];
...
// ################################################################################################
//   Automatic Refresh Function - Start
// ################################################################################################
...
// ################################################################################################
//   Automatic Refresh Function - End
// ################################################################################################
...
function CalculateRefreshTime() {
    if (isAutoRefresh) checkRefresh = (ar_Interval * 60);
}
// ################################################################################################
    ...
    try {
        ...
        jQuery.ajax({
            ...
            success: function (data){
              ...
              localStorage.getItem("ownedTrap")
            ) || {};

				var objTrap = {};
			  var data_components=data.components;
			  data_components.forEach(el => {
              if(!(el.classification === "weapon"||el.classification === "base"||el.classification === "trinket"||el.classification === "skin"||el.classification === "bait"))return;
              let key = el.name;
              ...
              //if(el.classification != "weapon"&&el.classification != "base"&&el.classification != "trinket"&&el.classification != "bait")continue;
              key=key.replace("Trap","").trim();
              ownedItems[key] = arr;
              ...
              // ^ i believe this is for synergy with equipment-preview, so it's not necessary for now
			            ...
			            // Edge case cleanup
            Object.keys(objTrap).forEach(el => {
              if (
...
localStorage.setItem(
              ...
              JSON.stringify(ownedItems)
                ...
                /*for (var i=0;i<data.components.length;i++){
                    if (data.components[i].classification != 'weapon'&&data.components[i].classification != 'base'&&data.components[i].classification != 'trinket'&&data.components[i].classification != 'bait')
                        continue;
...
function bodyJS(){
    ...
    var objDefaultBWRift = {
        ...
        priorities : ['ACOLYTE', 'GUARD', 'INGRESS', 'FROZEN', 'LUCKY', 'HIDDEN', 'TIMEWARP', 'RUNIC', 'ANCIENT', 'GEARWORKS', 'GEARWORKS', 'GEARWORKS', 'GEARWORKS'],
        prioritiesCursed : ['SECURITY', 'FURNACE', 'PURSUER', 'ACOLYTE', 'GUARD', 'INGRESS', 'FROZEN', 'LUCKY', 'HIDDEN', 'TIMEWARP', 'RUNIC', 'ANCIENT', 'GEARWORKS'],
        minTimeSand : [70,70,55,55,60,60,40,40,999],
        minRSCType : 'NUMBER',
        minRSC : 0,
        enterMinigameWCurse : false
    };
    ...
    function onInputGetMouse(){
        var classTreasureMap = document.getElementsByClassName('mousehuntHud-userStat treasureMap')[0];
        var test = classTreasureMap.children[2].textContent.toLowerCase().indexOf('remaining');
        alert(test);
        ...
        try {
            ...
            jQuery.ajax({
                ...
                success: function (data){
                    ...
                    console.log(data.treasure_map);
                    if(data.treasure_map.goals !== null && data.treasure_map.goals !== undefined){
                        var arrUncaught = [];
                        for(var i=0;i<data.treasure_map.goals.length;i++){
                            if(data.treasure_map.goals[i].is_uncaught === true){
                                for(var j=0;j<data.treasure_map.goals[i].mice.length;j++){
    ...
    var arrKey = ['VRift','QCArea','SCCustom','Labyrinth','LGArea','eventLocation','FW','BRCustom','SGarden','Zokor','FRift','MapHunting','ZTower','BestTrap','Iceberg','WWRift','GES','FRox','GWH2016R','SpecialFeature','BWRift','BC_JOD','FG_AR'];
    ...
    function onInputResetReload(){
        ...
        else if(strValue == 'QuesoCanyon') keyName = 'QCArea';
    ...
    function saveLaby(){
        ...
        var selectFocusedCharm = document.getElementById('selectFocusedCharm');
        ...
        var selectLabyrinthLanternUsage = document.getElementById('selectLabyrinthLanternUsage');
        ...
        storageValue.focusedCharm = selectFocusedCharm.value;
        ...
        storageValue.interDisarmBait = document.getElementById('interDisarmBait').value;
        storageValue.nDeadEndClue = parseInt(inputLabyrinthDEC.value);
        storageValue.weaponFarming = selectLabyrinthWeaponType.value;
        storageValue.lanternUsage = selectLabyrinthLanternUsage.value;
    ...
    function initControlsLaby(){
        ...
        var selectLabyrinthOtherBase = document.getElementById('selectLabyrinthOtherBase');
        var selectLabyrinthDisarmCompass = document.getElementById('selectLabyrinthDisarmCompass');
        var selectLabyrinthinterDisarmBait = document.getElementById('interDisarmBait');
        var inputLabyrinthDEC = document.getElementById('inputLabyrinthDEC');
        var selectLabyrinthWeaponType = document.getElementById('selectLabyrinthWeaponType');
        var selectLabyrinthLanternUsage = document.getElementById('selectLabyrinthLanternUsage');
        var storageValue = window.sessionStorage.getItem('Labyrinth');
        if(isNullOrUndefined(storageValue)){
            ...
            selectFocusedCharm.selectedIndex = -1;
            ...
            selectLabyrinthinterDisarmBait.selectedIndex = -1;
            ...
            selectFocusedCharm.value = storageValue.focusedCharm;
            ...
            selectLabyrinthinterDisarmBait.value = (storageValue.interDisarmBait) ? 'true' : 'false';
            ...
            selectLabyrinthLanternUsage.value = storageValue.lanternUsage;
        }
        ...
        document.getElementById('interDisarmBait').disabled = !(storageValue.chooseOtherDoors)? '' : 'disabled';
    }
    ...
    function saveQC(){
        var selectQCAutoBait = document.getElementById('selectQCAutoBait');
        var selectQCspiceLevel = document.getElementById('selectQCspiceLevel');
        var storageValue = window.sessionStorage.getItem('QCArea');
        if(isNullOrUndefined(storageValue)){
            var objQC = {
                levelQCspice : 'Bland Queso',
                armQCBait : false
            };
            storageValue = JSON.stringify(objQC);
        }
        storageValue = JSON.parse(storageValue);
        storageValue.armQCBait = (selectQCAutoBait.value == 'true');
        storageValue.levelQCspice = (selectQCspiceLevel.value);

        window.sessionStorage.setItem('QCArea', JSON.stringify(storageValue));
    }
    function saveVRift()
    {
        //console.log('saveVRift Entered');
        var selectValourRiftNormalTrinket = document.getElementById('selectValourRiftNormalTrinket');
        var selectValourRiftEclipseTrinket = document.getElementById('selectValourRiftEclipseTrinket');
        var selectValourRiftEclipseTrinketSafe = document.getElementById('selectValourRiftEclipseTrinketSafe');
        var selectValourRiftAutoEnter = document.getElementById('selectValourRiftAutoEnter');
        var selectValourRiftAugmentationSigilHunter = document.getElementById('selectValourRiftAugmentationSigilHunter');
        var selectValourRiftAugmentationSecretResearch = document.getElementById('selectValourRiftAugmentationSecretResearch');
        var selectValourRiftAugmentationSuperSiphon = document.getElementById('selectValourRiftAugmentationSuperSiphon');
        var selectValourRiftAugmentationUltimateUmbra = document.getElementById('selectValourRiftAugmentationUltimateUmbra');
        var selectValourRiftAugmentationElixirRain = document.getElementById('selectValourRiftAugmentationElixirRain');
        var selectValourRiftAugmentationStringStepping = document.getElementById('selectValourRiftAugmentationStringStepping');
        var selectValourRiftFireUsage= document.getElementById('selectValourRiftFireUsage');
        // console.log(selectValourRiftNormalTrinket.value);
        //console.log(selectValourRiftEclipseTrinket.value);
        //console.log(selectValourRiftAutoEnter.value);
        var storageValue = window.sessionStorage.getItem('VRift');
        //console.log(storageValue);
        if(isNullOrUndefined(storageValue)){
            var objVRift = {
                ValourRiftNormalTrinket : 'Rift Vaccum',
                ValourRiftEclipseTrinket : 'Rift Vaccum',
                ValourRiftEclipseTrinketSafe : 'Rift Vaccum',
                ValourRiftAutoEnter : true,
                ValourRiftAugmentationSigilHunter : false,
            ...
            storageValue = JSON.stringify(objVRift);
        }
        storageValue = JSON.parse(storageValue);
        // console.log(storageValue);
        storageValue.ValourRiftAutoEnter = (selectValourRiftAutoEnter.value == 'true');
        storageValue.ValourRiftAugmentationSigilHunter = (selectValourRiftAugmentationSigilHunter.value == 'true');
        storageValue.ValourRiftAugmentationSecretResearch = (selectValourRiftAugmentationSecretResearch.value == 'true');
        storageValue.ValourRiftAugmentationSuperSiphon = (selectValourRiftAugmentationSuperSiphon.value == 'true');
        storageValue.ValourRiftAugmentationUltimateUmbra = (selectValourRiftAugmentationUltimateUmbra.value == 'true');
        storageValue.ValourRiftAugmentationElixirRain = (selectValourRiftAugmentationElixirRain.value == 'true');
        storageValue.ValourRiftAugmentationStringStepping = (selectValourRiftAugmentationStringStepping.value == 'true');
        storageValue.ValourRiftNormalTrinket = (selectValourRiftNormalTrinket.value);
        storageValue.ValourRiftEclipseTrinket = (selectValourRiftEclipseTrinket.value);
        storageValue.ValourRiftEclipseTrinketSafe = (selectValourRiftEclipseTrinketSafe.value);
        storageValue.ValourRiftFireUsage = (selectValourRiftFireUsage.value);
        // console.log(storageValue);
        window.sessionStorage.setItem('VRift', JSON.stringify(storageValue));
    }
    function initControlsVRift(bAutoChangeVRift){
        //console.log('Enter init ControlVrift');
        //    var augmentationUsage={"Sigil Hunter":true,"Secret Research":false,"Super Siphon":false,"Ultimate Umbra":false,"Elixir Rain":false,"String Stepping":false};
        if(isNullOrUndefined(bAutoChangeVRift)) {
            bAutoChangeVRift = false;
        }
        var selectValourRiftNormalTrinket = document.getElementById('selectValourRiftNormalTrinket');
        var selectValourRiftEclipseTrinket = document.getElementById('selectValourRiftEclipseTrinket');
        var selectValourRiftEclipseTrinketSafe = document.getElementById('selectValourRiftEclipseTrinketSafe');
        ...
        //console.log(storageValue);
        if(isNullOrUndefined(storageValue)) {
            selectValourRiftNormalTrinket.selectedIndex = -1;
            selectValourRiftEclipseTrinket.selectedIndex = -1;
            selectValourRiftEclipseTrinketSafe.selectedIndex = -1;
            selectValourRiftAutoEnter.selectedIndex = -1;
            selectValourRiftAugmentationSigilHunter.selectedIndex = -1;
            selectValourRiftAugmentationSecretResearch.selectedIndex = -1;
            selectValourRiftAugmentationSuperSiphon.selectedIndex = -1;
            selectValourRiftAugmentationUltimateUmbra.selectedIndex = -1;
            selectValourRiftAugmentationElixirRain.selectedIndex = -1;
            selectValourRiftAugmentationStringStepping.selectedIndex = -1;
            selectValourRiftFireUsage.selectedIndex = -1;
        }
        else {
            storageValue = JSON.parse(storageValue);
        }
        selectValourRiftNormalTrinket.value=storageValue.ValourRiftNormalTrinket;
        selectValourRiftEclipseTrinket.value=storageValue.ValourRiftEclipseTrinket;
        selectValourRiftEclipseTrinketSafe.value=storageValue.ValourRiftEclipseTrinketSafe;
        selectValourRiftFireUsage.value=storageValue.ValourRiftFireUsage;
        selectValourRiftAutoEnter.value=(storageValue.ValourRiftAutoEnter)? 'true':'false';
        selectValourRiftAugmentationSigilHunter.value=(storageValue.ValourRiftAugmentationSigilHunter)? 'true':'false';
        selectValourRiftAugmentationSecretResearch.value=(storageValue.ValourRiftAugmentationSecretResearch)? 'true':'false';
        selectValourRiftAugmentationSuperSiphon.value=(storageValue.ValourRiftAugmentationSuperSiphon)? 'true':'false';
        selectValourRiftAugmentationUltimateUmbra.value=(storageValue.ValourRiftAugmentationUltimateUmbra)? 'true':'false';
        selectValourRiftAugmentationElixirRain.value=(storageValue.ValourRiftAugmentationElixirRain)? 'true':'false';
        selectValourRiftAugmentationStringStepping.value=(storageValue.ValourRiftAugmentationStringStepping)? 'true':'false';
    }
    function initControlsQC(bAutoChangeQueso){
        if(isNullOrUndefined(bAutoChangeQueso)) {
            bAutoChangeQueso = false;
        }
        var selectQCAutoBait = document.getElementById('selectQCAutoBait');
        var selectQCspiceLevel = document.getElementById('selectQCspiceLevel');
        var storageValue = window.sessionStorage.getItem('QCArea');
        if(isNullOrUndefined(storageValue)) {
            selectQCAutoBait.selectedIndex = -1;
            selectQCspiceLevel.selectedIndex = -1;
        }
        else {
            storageValue = JSON.parse(storageValue);
        }
        selectQCAutoBait.value = (storageValue.armQCBait) ? 'true' : 'false';
        selectQCspiceLevel.value = storageValue.levelQCspice;
    }
    ...
    function showOrHideTr(algo){
        var labyTrs = ('trLabyrinth','trLabyrinthOil','trPriorities15','trPriorities1560','trPriorities60','trLabyrinthOtherHallway','trLabyrinthDisarm','trLabyrinthArmOtherBase','trLabyrinthDisarmCompass','trLabyrinthIntersection','trLabyrinthWeaponFarming','trLabyrinthLanternUsage');
        var objTableRow = {
            'All LG Area' : {
            ...
            'Labyrinth' : {
                arr : ['trLabyrinth','trPriorities15','trPriorities1560','trPriorities60','trLabyrinthOtherHallway','trLabyrinthDisarm','trLabyrinthArmOtherBase', 'trLabyrinthDisarmCompass','trLabyrinthIntersection','trLabyrinthWeaponFarming','trLabyrinthLanternUsage'],
                //arr : [labyTrs],
            ...
            'QuesoCanyon' : {
                arr : ['trQuesoCanyonAutoCheese','trQuesoCanyonSpiceLevel'],
                init : function(data){initControlsQC(data);}
            },
            'Zokor' : {
            ...
            'Valour Rift' : {
                arr : ['trValourRiftNormalTrinket', 'trValourRiftEclipseTrinket','trValourRiftEclipseTrinketSafe','trValourRiftAutoEnter','trValourRiftAugmentation','trValourRiftFireUsage'],
                init : function(data){initControlsVRift(data);}
            },
        };
        var i, temp;
